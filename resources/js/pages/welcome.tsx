...
import NavbarAuth from '@/components/main/navbar-auth';
                ...
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 bg-white rounded-lg shadow p-6">
                        <div className="flex space-x-2 mb-4">
                            <span className="text-xs bg-gray-200 text-gray-700 px-3 py-1 rounded-full">Tips</span>
                            <span className="text-xs bg-gray-200 text-gray-700 px-3 py-1 rounded-full">Lifestyle</span>
                            <span className="text-xs bg-gray-200 text-gray-700 px-3 py-1 rounded-full">Inspiration</span>
                        </div>

                        <h1 className="text-2xl font-bold mb-4">Produk Tumbler Tahan Api</h1>
                        ...
                        <div className="bg-white p-4 rounded-lg mb-6">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center space-x-4">
                                    <img src="https://via.placeholder.com/40" alt="Author" className="rounded-full h-10 w-10" />
                                    <div>
                                        <p className="text-sm font-bold text-gray-800 flex items-center">
                                            John Alexander
                                            <a href="#" className="text-blue-500 ml-2 text-sm">Follow</a>
                                        </p>
                                        <p className="text-xs text-gray-500">Published in Fantare • 21 Oktober 2024</p>
                                    </div>
                                </div>
                        ...
                        <div className="mb-6">
                            <img src="https://via.placeholder.com/800x400" alt="Artikel" className="rounded-lg w-full object-cover" />
                        </div>
                    ...
                    <aside className="bg-white rounded-lg shadow p-6">
                        <h2 className="text-lg font-bold mb-4">Rekomendasi Artikel</h2>
                        <ul className="space-y-4">
                            <li className="flex items-center space-x-4">
                                <img src="https://via.placeholder.com/80" alt="Artikel" className="rounded-lg h-16 w-16 object-cover" />
                                <div>
                                    <p className="font-bold text-sm text-gray-800">Produk Tumbler Tahan Api</p>
                        ...
                        <h2 className="text-lg font-bold mt-8 mb-4">Artikel Lainnya</h2>
                        <ul className="space-y-4">
                            <li className="flex items-center space-x-4">
                                <img src="https://via.placeholder.com/80" alt="Artikel" className="rounded-lg h-16 w-16 object-cover" />
                                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white rounded-lg shadow overflow-hidden">
                            <div className="relative">
                                <img src="https://via.placeholder.com/300" alt="Berita" className="w-full h-40 object-cover" />
                                <span className="absolute top-2 left-2 bg-gray-700 text-white text-xs font-bold px-3 py-1 rounded-lg">
                                    Category
                                </span>
                            </div>
                            <div className="p-4">
                                ...
                                <h3 className="font-bold text-sm mb-2">Produk Tumbler Tahan Api</h3>
                                <p className="text-xs text-gray-500 mb-4">Berikut 5 tumbler favorit anak muda yang tahan api...</p>
                    ...
                    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                        ...
                        <div className="hidden lg:relative lg:block lg:p-12">
                            ...
                            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                                Welcome to WinnieNews
                            </h2>

                            <p className="mt-4 leading-relaxed text-white/90">
                                Sebelum baca daftar akunmu dulu yuk!
                            </p>
                        </div>
                    </section>
                        ...
                        <div className="max-w-xl lg:max-w-3xl">
                            <div className="relative -mt-16 block lg:hidden">
                                ...
                                <h1 className="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl dark:text-white">
                                    Selamat datang di Akun WinnieNews
                                </h1>

                                <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
                                    Sebelum baca daftar akunmu dulu yu!
                                </p>
                            </div>
                            ...
                            <form className="mt-8 grid grid-cols-6 gap-6">
                                <div className="col-span-6 sm:col-span-12">
                                    ...
                                    <input type="text" id="fullname" className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200" required />
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-12">
                                    ...
                                    <input type="text" id="username" className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200" required />
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-12">
                                    ...
                                    <input type="email" id="email" className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200" required />
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-12">
                                    ...
                                    <input type="password" id="Password" className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200" required />
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-12">
                                    ...
                                    <input type="password" id="PasswordConfirmation" className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200" required />
                                </div>

                                <div className="col-span-6">
                                    <label htmlFor="MarketingAccept" className="flex gap-4">
                                        <input type="checkbox" id="MarketingAccept" name="marketing_accept" className="size-5 rounded-md border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:focus:ring-offset-gray-900" required />
                                ...
                                <div className="col-span-6">
                                    <button type="submit" className="mt-4 w-full rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800">
                                        Daftar
                                    </button>
                                </div>
                            </form>
                        ...
                        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                            ...
                            <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
                                <div className="max-w-xl lg:max-w-3xl">
                                    ...
                                    <form className="mt-8 grid grid-cols-6 gap-6">
                                        <div className="col-span-6 sm:col-span-12">
                                            <label for="email" className="block text-sm font-medium text-gray-700 dark:text-gray-200">
                                                Email
                                            </label>
                                        ...
                                        <div className="col-span-6 sm:col-span-12">
                                            <label for="password" className="block text-sm font-medium text-gray-700 dark:text-gray-200">
                                                Password
                                            </label>
                                        ...
                                        <div className="col-span-6">
                                            <button type="submit"
                                                className="mt-4 w-full rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800">
                                                Daftar
                                            </button>
                                        </div>
                                    </form>
